...
for.het.iucn<-for.het[!is.na(for.het[, 2]), ]
for.soh.iucn<-for.soh[!is.na(for.soh[, 2]), ]
...
####determine relationship if labels assigned at random, determine probability of real observation
